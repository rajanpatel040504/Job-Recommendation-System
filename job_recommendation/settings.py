...
SECRET_KEY = "django-insecure-mo$31#5g7bd8d6e!a!5$su!xqy+2ap2otmxo_)wkk7@&xh*o=%"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'placement',  # My PostgreSQL database name
        'USER': 'postgres',    # My PostgreSQL username
        'PASSWORD': '1234',    # My PostgreSQL password
...
AUTH_USER_MODEL = 'jobs.UserProfile'